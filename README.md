...
\* \*\*Transparency:\*\* Ensure your `fish\_green` file is saved with a transparent background. Without transparency, the detection algorithm will fail.
...
| `roi\_strike` | The area containing the "Strike" text. Keep it tight to avoid color conflicts; a dark background is recommended. |

| `roi\_kutu` | The thin box area shown in the reference image. !\[image](2.png) |

| `roi\_balik` | The main fishing area. \*\*Critical:\*\* Select this area carefully. !\[image](7.png) |

| `roi\_land` | The landing zone for the catch. !\[image](4.png)|

| `roi\_net` | The net capture zone. Define this area as concisely as possible. !\[image](1.png)|

| `roi\_take` | The interaction/collect area. !\[image](3.png)|

| `roi\_world` | The navigation area. Capture this widely (ignore arrows for now). !\[image](5.png)|
...
&#x20;   \* \*\*Location #1:\*\* Replace `guvenli\_tikla(956, 529)` with the coordinates for the first recovery point.

&#x20;   \* \*\*Location #2:\*\* Replace `guvenli\_tikla(848, 658)` with the coordinates for the second recovery point.

&#x20;   \* \*\*Location #3:\*\* Replace `guvenli\_tikla(1041, 865)` with the coordinates for the third recovery point. \*\*Note: Your inventory must be visible as shown in the image.\*\*
